...
public class playerControl : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        lua=LuaMgr.GetInstance().Global.Get<LuaTrigger>("TriggerDetector");
    }
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.tag == "collection")
        {
            ...
            lua.OnTriggerEnter.Call(collision);
            //collision.tag = null;
            //cherryAudio.Play();
    ...
    void Restart()
    {
        ...
        CherryNumberMgr.Instance.DestroyCherry();
    }
